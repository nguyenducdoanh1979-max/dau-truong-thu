...
export default function Page() {
  ...
  const [tab, setTab] = useState<"overview" | "students" | "points" | "guilds" | "arena" | "conquest" | "questions" | "assignments" | "submissions" | "rankings" | "events" | "settings">("overview");
  ...
  useEffect(() => {
    if (!hydrated) return;
    localStorage.setItem(STORAGE_KEY, JSON.stringify({ guilds, students, eventLogs, conquestBattles, duelMatches, territoryRaids, arenaRuns, questions, assignments, submissions, adminPassword }));
  }, [hydrated, guilds, students, eventLogs, conquestBattles, duelMatches, territoryRaids, arenaRuns, questions, assignments, submissions, adminPassword]);
